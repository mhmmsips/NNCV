...
#NOTE: This is not used for the assignment anymore, as probably has data leakage. Training it from scratch was too difficult, so switched to something else.
